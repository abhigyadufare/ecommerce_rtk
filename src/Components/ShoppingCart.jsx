...
import { removeItemFromCart, clearCart, increaseItemQuantity, decreaseitemQuantity } from './CartSlice'; //Action creators for increasing and decreasing item quantity
